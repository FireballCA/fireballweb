      ...
      <section className="cta-section">
        <div className="container-narrow">
          ...
          <div className="cta-btns reveal reveal-delay-2">
            ...
            <Link
              to="/join-fireball"
              className="group inline-flex items-center gap-1.5 text-sm font-nav font-bold uppercase text-carbon-700 hover:text-carbon-900 transition-colors duration-200"
            >
