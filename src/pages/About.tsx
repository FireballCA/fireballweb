    ...
    <main className="bg-black text-white min-h-screen">
      ...
      <section className="manifesto">
        <div className="container-narrow">
          <p className="manifesto-text reveal reveal-delay-1">
            ...
            <strong>That finish. That depth. That presence.</strong> Not for a weekend — forever.
          </p>
        </div>
      </section>
      ...
      <section className="cta-section">
        <div className="container-narrow">
          ...
          <p className="cta-sub reveal reveal-delay-1">Explore our product line or become part of the Fireball network.</p>
          <div className="cta-btns reveal reveal-delay-2">
            ...
            <Link
              to="/join-fireball"
              className="inline-block px-8 py-3.5 border border-silver/30 text-carbon-900 font-nav font-bold text-sm uppercase rounded-lg hover:bg-carbon-700/10 transition-all duration-300"
            >
              Join Fireball Network
            </Link>
          </div>
        </div>
      </section>
