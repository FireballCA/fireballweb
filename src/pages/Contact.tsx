        ...
        <div className="flex-shrink-0 lg:w-1/2 lg:min-w-0 flex flex-col justify-center px-6 lg:px-12 xl:px-16 py-8 lg:py-12 border-t lg:border-t-0 lg:border-l border-carbon-900/10">
          ...
          <form className="mt-6 space-y-3 md:space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              ...
              className="group inline-flex items-center gap-1.5 text-xs font-medium text-carbon-700 hover:text-carbon-900 disabled:text-carbon-400 disabled:hover:text-carbon-400 disabled:cursor-not-allowed transition-colors duration-200"
            >
              Send message
              <svg
                xmlns="http://www.w3.org/2000/svg"
