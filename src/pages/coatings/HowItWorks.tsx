...
const COMPOUNDS = [
  ...
  },
  {
    ...
    body: 'Exclusive to Butterfly Graphene. A single-atom-thick carbon lattice — the strongest material ever measured by weight. Integrated as graphene oxide into the SiO₂ matrix, it dramatically increases water-spot resistance, chemical durability, and slickness.',
    stat: '200×',
...
export function HowItWorks() {
  ...
  const BENEFITS = [
    ...
    { title: 'Scratch resistance', sub: 'Stronger protection than factory clear coat. Helps resist swirl marks and light abrasion.' },
