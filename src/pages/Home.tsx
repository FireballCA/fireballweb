...
export function Home() {
  ...
  /** Mobile : image statique + pas d’animations hero lourdes pour limiter les crashs navigateur. */
          ...
          <div className="mx-auto flex w-full max-w-[90rem] flex-col items-center gap-8 text-center md:flex-row md:items-end md:justify-between md:gap-12 md:text-left">
            ...
            <div className="flex w-full max-w-lg shrink-0 flex-col items-center gap-6 text-center md:max-w-none md:w-auto md:items-end md:text-right">
              <span className={heroLite ? '' : 'hero-ground-line hero-ground-line--clean'}>
                <p
                  className={cn(
                    'mx-auto max-w-md text-pretty font-light text-silver/80 text-sm leading-relaxed md:mx-0 md:text-base lg:text-lg',
              ...
              <span className={heroLite ? '' : 'hero-ground-line hero-ground-line--clean'}>
                <span className={heroLite ? '' : 'hero-ground-text hero-ground-text--delay-3 inline-block'}>
                  <button
                    type="button"
        ...
        <section className="bg-carbon-950 py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 text-center md:px-6">
            <div className="mx-auto flex max-w-3xl flex-col items-center gap-3">
              ...
              <Link to="/find-installer" className={cn('mt-2 inline-flex', appleButtonVisualClassName)}>
                Find near you
              </Link>
            </div>
          </div>
