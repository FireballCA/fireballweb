  ...
  return (
    <div className="relative overflow-x-hidden">
      ...
      >
        ...
        <div className={`relative z-10 flex min-h-0 w-full flex-1 flex-col justify-center px-5 pb-24 pt-20 sm:px-6 md:justify-end md:pb-28 md:pt-16 ${useSafeMobileLanding ? '' : 'animate-slide-up'}`}>
          <div className="mx-auto flex w-full max-w-[90rem] flex-col items-center gap-8 text-center md:flex-row md:items-end md:justify-between md:gap-12 md:text-left">
            <h1 className="max-w-xl font-nav text-4xl font-bold leading-[1.05] tracking-tight text-pearl sm:text-5xl md:max-w-lg md:self-start md:text-6xl lg:text-7xl">
              <span className={useSafeMobileLanding ? '' : 'hero-ground-line hero-ground-line--clean'}>
                <span className={useSafeMobileLanding ? '' : 'hero-ground-text'}>From Detail</span>
              </span>
              <span className={`${useSafeMobileLanding ? '' : 'hero-ground-line hero-ground-line--clean'} mt-1.5 sm:mt-2`}>
                <span className={useSafeMobileLanding ? '' : 'hero-ground-text hero-ground-text--delay'}>To Perfection.</span>
              </span>
            </h1>
            <div className="flex w-full max-w-lg shrink-0 flex-col items-center gap-6 text-center md:max-w-none md:w-auto md:items-end md:text-right">
              <span className={useSafeMobileLanding ? '' : 'hero-ground-line hero-ground-line--clean'}>
                <p className={`${useSafeMobileLanding ? '' : 'hero-ground-text hero-ground-text--delay-2'} mx-auto max-w-md text-pretty font-light text-silver/80 text-sm leading-relaxed md:mx-0 md:text-base lg:text-lg`}>
                  Crafted for those who demand precision, performance, and flawless results.
                </p>
              </span>
              <span className={useSafeMobileLanding ? '' : 'hero-ground-line hero-ground-line--clean'}>
                <span className={`${useSafeMobileLanding ? '' : 'hero-ground-text hero-ground-text--delay-3'} inline-block`}>
                  <button
                    type="button"
            ...
            <div className="mx-auto mt-8 max-w-7xl px-4 md:px-6">
              <div className="overflow-hidden rounded-2xl bg-carbon-900">
                <div className="h-[240px] w-full p-2 md:h-[460px]">
                  {useSafeMobileLanding ? (
                    <div className="h-full w-full rounded-xl bg-carbon-800" aria-hidden />
                  ) : (
                    <WorldMapDemo />
                  )}
                </div>
