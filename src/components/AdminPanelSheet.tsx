      ...
      >
        ...
        <div className="pb-5 lg:hidden pointer-events-none flex justify-end">
          <button
            type="button"
            onClick={onClose}
            className={`pointer-events-auto inline-flex items-center justify-center gap-2 rounded-full border border-white/[0.18] bg-white/[0.08] backdrop-blur-md text-white/80 hover:bg-white/[0.16] hover:text-white transition-all duration-300 ${
              scrolledDown
                ? 'w-10 h-10 mr-5 px-0 text-[0]'
