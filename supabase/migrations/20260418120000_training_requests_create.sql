-- Création de public.training_requests (doit s'exécuter avant 20260419_admin_training_partner_workflow.sql)
-- Équivalent à supabase_training_requests.sql à la racine du repo.
